<form action="action_page.php">
  <div class="container">
    ...
    <input type="text" placeholder="Enter Full in CAPITAL Name" name="Name" id="Name" required>
    <br>
    ...
    <input type="password" placeholder="Enter LONGPassword" name="psw" id="psw" required>
    <br>
